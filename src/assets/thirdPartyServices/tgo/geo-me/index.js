...
export default class GeoMeService extends React.Component {
    ...
    this.state = {
      ...
      exampleList: [
        { label: "Custom Input", value: "0", content: "" },
        {
          label: "Example - Fiji",
          value: "1",
          content: "https://raw.githubusercontent.com/tgotech/geo-me-doco/master/examples/example_input_fiji.json",
        },
        {
          label: "Example - Fiji2",
          value: "2",
          content: "https://raw.githubusercontent.com/tgotech/geo-me-doco/master/examples/example_input_fiji2.json",
        },
        {
          label: "Example - Fiji3",
          value: "3",
          content: "https://raw.githubusercontent.com/tgotech/geo-me-doco/master/examples/example_input_fiji3.json",
        },
        {
          label: "Example - Fiji4",
          value: "4",
          content: "https://raw.githubusercontent.com/tgotech/geo-me-doco/master/examples/example_input_fiji4.json",
        },
        {
          label: "Example - London",
          value: "5",
          content: "https://raw.githubusercontent.com/tgotech/geo-me-doco/master/examples/example_input_london.json",
        },
        {
          label: "Example - London2",
          value: "6",
          content: "https://raw.githubusercontent.com/tgotech/geo-me-doco/master/examples/example_input_london2.json",
        },
        {
          label: "Example - London3",
          value: "7",
          content: "https://raw.githubusercontent.com/tgotech/geo-me-doco/master/examples/example_input_london3.json",
        },
        {
          label: "Example - London4",
          value: "8",
          content: "https://raw.githubusercontent.com/tgotech/geo-me-doco/master/examples/example_input_london4.json",
        },
        {
          label: "Example - Buenos Aires",
          value: "9",
          content:
            "https://raw.githubusercontent.com/tgotech/geo-me-doco/master/examples/example_input_buenosaires.json",
        },
        {
          label: "Example - Buenos Aires2",
          value: "10",
          content:
            "https://raw.githubusercontent.com/tgotech/geo-me-doco/master/examples/example_input_buenosaires2.json",
        },
        {
          label: "Example - Buenos Aires3",
          value: "11",
          content:
            "https://raw.githubusercontent.com/tgotech/geo-me-doco/master/examples/example_input_buenosaires3.json",
        },
        {
          label: "Example - Buenos Aires4",
          value: "12",
          content:
            "https://raw.githubusercontent.com/tgotech/geo-me-doco/master/examples/example_input_buenosaires4.json",
        },
        {
          label: "Example - Fiji [Inconsistent Data]",
          value: "13",
          content:
            "https://raw.githubusercontent.com/tgotech/geo-me-doco/master/examples/example_input_fiji_inconsistent.json",
        },
      ],
      input: "",
    };
  ...
  submitAction() {
    ...
    json_data.observation.forEach(element => {
          ...
          <React.Fragment>
            <Grid item xs={12} style={{ textAlign: "left" }}>
              <h5 style={{ marginBottom: "10px" }}>
                <p>
                  A valid input should be in the JSON format, contain a target name and Id and at least two
                  observations. A result will only be computed for observations which are generally agreeable in their
                  location estimation. In other words, poor observations will likely result in an inaccurate or invalid
                  result.
                </p>
                <p>
                  See the{" "}
                  <a href={this.state.userguide} style={{ fontSize: 15 }}>
                    User Guide
                  </a>{" "}
                  for detailed explanations and an example data simulator, or use an example from the list below.
                </p>
              </h5>
              <OutlinedDropDown
                id="params"
                ...
                htmlTooltip={
                  <React.Fragment>
                    <div style={{ fontSize: "15px" }}>
                      ...
                      <p>
                        An example data simulator is linked in the User Guide which allows further custom example
            ...
            {!this.props.isComplete && (
              <Grid item xs={12} style={{ textAlign: "center", marginTop: "10px", marginBottom: "10px" }}>
                <Button
                  ...
                  title="Press to call the service"
                >
                  Invoke
                </Button>
              </Grid>
              ...
              <React.Fragment>
                ...
                <div>
                  <Button
                    ...
                    variant="contained"
                    color="secondary"
                    onClick={this.downloadKmlFile}
                    disabled={!this.hasKml()}
                    title={!this.hasKml() ? "No Kml" : "Press to Download a KML Map Layer"}
                  >
                    Download Kml Output
                  </Button>
                </div>
